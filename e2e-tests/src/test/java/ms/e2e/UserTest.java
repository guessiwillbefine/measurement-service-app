...
/** user scenario tests - modifying, deleting, searching users. **/
...
class UserTest {
    ...
    @Test
    @DisplayName("test that after deleting there is 1 less user in database")
    ...
    @Test
    @DisplayName("test updating user and getting entity back after modifying")
